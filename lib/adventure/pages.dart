    ...
    return Column(
      children: [
        ...
        SizedBox(
          height: 80,
          child: Padding(
              padding: const EdgeInsets.all(8.0), child: VocabularyView()),
        ),
      ],
    );
  }
    ...
    return Scaffold(
      ...
      body: StoreConnector<AppState, AdventureState>(
          ...
          builder: (context, state) {
            ...
            int index = min(state.taskIndex, state.adventure.taskData.length - 1);
            return Padding(
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, AdventureState>(
        ...
        builder: (context, state) {
          ...
          BoxDecoration selected = BoxDecoration(boxShadow: [
            BoxShadow(
                      ...
                      Row(
                        ...
                        children: [
                          ...List.generate(state.taskStates.length, (index) {
                            Color color =
                                getDiffColor(state.taskStates[index].diff);
                            return <Widget>[
                              Container(
                                child: CircleColor(
                                  color: color,
                                ...
                                decoration:
                                    index == state.taskIndex ? selected : null,
                              )
                            ];
                  ...
                  if (state.hasDoneButton)
                    IconButton(
                      ...
                      onPressed: () {
                        ...
                        Redux.dispatch(AdventureValidate(true));
                      },
                    )
                  else
                    IconButton(
